...
class Movie(models.Model):
    ...
    language = models.CharField(max_length=50, choices=LANGUAGE_CHOICES)  # Using choices for language
    ...
    movie_file = models.FileField(upload_to='movies/', null=True)  # Allow null values
    poster_image = models.ImageField(upload_to='posters/', null=True)  # Allow null values
